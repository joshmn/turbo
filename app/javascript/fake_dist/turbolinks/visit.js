...
var Visit = /** @class */ (function () {
    function Visit(delegate, location, restorationIdentifier, options) {
        ...
        var _a = __assign(__assign({}, defaultOptions), options), action = _a.action, historyChanged = _a.historyChanged, referrer = _a.referrer, response = _a.response;
        this.action = action;
    ...
    Visit.prototype.getCachedSnapshot = function () {
        var snapshot = this.view.getCachedSnapshotForLocation(this.location);
